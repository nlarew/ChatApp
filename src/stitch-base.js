...
export async function loginEmailPassword(email, password) {
  // return await app.auth.loginWithCredential(new UserPasswordCredential(email, password));
}
...
// Collection that contain chatroom documents
...
export async function createChatroom({ name }) {
  ...
  //   administrators: [app.auth.currentUser.id],
...
export function archiveRoom(room_id) {
